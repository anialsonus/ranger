...
//
// ServicePolicies class has been
// copied from agents-common/src/main/java/org/apache/ranger/plugin/util/ServicePolicies.java
// and edited then
//
...
public class ServicePolicies implements java.io.Serializable {
    ...
    public Map<String, Set<String>> getGroupRoles() {
        return groupRoles;
    }
